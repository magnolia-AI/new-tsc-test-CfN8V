...
function RootLayout(_a) {
    ...
    return (<html lang="en" className="h-full" suppressHydrationWarning>
      <body className="h-full flex flex-col antialiased">
        <theme_provider_1.ThemeProvider defaultTheme="light" attribute="class">
          {/*
        ...
        */}
              ...
              <div className="flex items-center gap-2">
                ...
                <button_1.Button variant="outline" size="sm" className="border-amber-800 text-amber-800 hover:bg-amber-800 hover:text-white rounded-none">Become a Member</button_1.Button>
              </div>
            </div>
          </header>
